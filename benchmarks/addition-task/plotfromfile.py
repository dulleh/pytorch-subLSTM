...
if __name__ == '__main__':
    ...
    plt.plot(np.arange(1, len(lstmunfusedtimes)+1, 1), lstmunfusedtimes, label='LSTM Py (unfused)')
    plt.plot(np.arange(1, len(lstmfusedtimes)+1, 1), lstmfusedtimes, label='LSTM (fused+)')
    plt.legend()
